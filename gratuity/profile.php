...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-3 col-sm-3"    <?php if($agent==1){ echo 'style="position: fixed;"';} ?>  >
      ...
      <div class="thumbnail">
        <img class="img-rounded" src="http://placehold.it/180x180" alt="">
        <div class="caption">
     ...
     <div class="col-md-8 col-sm-8" style="float: right; <?php if ($agent==0){echo "width:100%;";}  ?> ">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-lg-12 col-md-12">
          <div class="well" style="color: white; background-image: linear-gradient(to bottom,#00BEF2 0,#00BEF2 100%);text-align:center;<?php if($agent==1) { echo 'font-size: xx-large;';}?>">Personal Info</div>
          <div class="thumbnail" style="text-align:center;"><a class="pull-right"href="">Edit</a></p>
           <p><strong>Email:</strong> user@gmail.com</p>
           <p><strong>Password:</strong> xxxxx <a href="">change</a></p>
           <p><strong>About you:</strong> aabskdkjasndnaskjn 
           <div class="caption">

            <h4><a href="#" class="btn btn-info">Submit</a>
            </h4>
