        ...
        <div class="col-md-6 col-md-offset-3">
          <form class="navbar-form " role="form" style="text-align: center;">
           <div class="form-group">
             ...
             <button type="button" class="btn btn-block btn-lg btn-info" data-toggle="modal" data-target=".xt" style="width:500px;">Sign Up/Log In</button></li>
 ...
 <div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-3"    <?php if($agent==1){ echo 'style="position: fixed;"';} ?>  >
      ...
      text-align: center;
      ">
      <a href="#" class="list-group-item">Medical Supplies<span style="margin-left:5px;color: #00bef2;" class="glyphicon glyphicon-plus" ></a>
        <a href="#" class="list-group-item">Funds<span style="margin-left:5px;color: #00bef2;" class="glyphicon glyphicon-gbp" ></span></a>
        <a href="#" class="list-group-item">Clothes<span style="margin-left:5px;color: #00bef2;" class="glyphicon glyphicon-briefcase" ></a>
        <a href="#" class="list-group-item">Food<span style="margin-left:5px;color: #00bef2;" class="glyphicon glyphicon-glass" ></a>
  ...
  <div class="col-md-8" style="float: right;">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-lg-12 col-md-12">
        <div class="well" style="color: white; background-image: linear-gradient(to bottom,#00BEF2 0,#00BEF2 100%);text-align:center;<?php if($agent==1) { echo 'font-size: xx-large;';}?>">People In Need</div>
...
<?php
  $query = query("SELECT * FROM c_userdata ORDER BY id DESC");
    ...
    echo '<div class="list-group">
      <a href="needy?email='.$rowr['email'].'" class="list-group-item card">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2" style="/* text-align:center; */margin-top:10px;">
                    © 2015 Gratuity.in All rights reserved.
